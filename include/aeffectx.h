...
constexpr int effGetParamDisplay = 7; // See REAPER extension: https://www.cockos.com/reaper/sdk/vst/vst_ext.php
...
constexpr int effCanBeAutomated = 26; // currently unused
constexpr int effString2Parameter = 27; // currently unused
constexpr int effGetProgramNameIndexed = 29;
constexpr int effSetBypass = 44; // currently unused
...
constexpr int effVendorSpecific = 50; // currently unused
constexpr int effCanDo = 51; // currently unused
constexpr int effGetTailSize = 52; // currently unused
constexpr int effGetVstVersion = 58; // currently unused
constexpr int effGetMidiKeyName = 66; // currently unused
